...
export default class AddConsumerScreen extends Component {
  ...
  render() {
    ...
    return (
      <View style={{flex:1}}>
        <AppHeader title={"Add Customer"} isMenu={false} navigation={this.props.navigation}/>
          <DismissKeyboard>
            <KeyboardAvoidingView
              style={{justifyContent: 'center',}} behavior='height'>
              <ScrollView>
          ...
          {/* summited spinner */}
          {this.state.submitted ? <View style={{position:'absolute',bottom:15 ,right:35}}><ActivityIndicator size='small' color={'#20bf6b'} /></View> : null}
        </View>
    );
  }
}
