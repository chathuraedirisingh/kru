...
export default class AccordionList extends Component {
    ...
    renderView = (param) => {
        ...
        else if (param === List.ACCOUNT_SUMMARY) {return ( < AccountSummary /> )}
        else {return ( < Blank /> )}
    }

    render() {
        const { chooseExpandView } = this.state;
        const UP_ARROW_ICON = require('../../../assets/images/arrow-up.png');
        const DOWN_ARROW_ICON = require('../../../assets/images/arrow-down.png');
